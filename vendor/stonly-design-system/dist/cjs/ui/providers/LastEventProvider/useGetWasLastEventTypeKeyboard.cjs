...
__webpack_require__.d(__webpack_exports__, {
    useGetWasLastEventTypeKeyboard: ()=>useGetWasLastEventTypeKeyboard
});
...
function useGetWasLastEventTypeKeyboard() {
    const context = (0, external_react_namespaceObject.useContext)(external_LastEventProvider_cjs_namespaceObject.LastEventContext);
