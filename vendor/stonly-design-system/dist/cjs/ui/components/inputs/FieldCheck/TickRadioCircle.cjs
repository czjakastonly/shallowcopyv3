...
__webpack_require__.d(__webpack_exports__, {
    TickRadioCircle: ()=>TickRadioCircle
});
...
const IconTick = external_styled_components_default().span`
  content: '';
  height: 6px;
  width: 6px;
  ...
  display: block;
`;
const Circle = external_styled_components_default().div`
...
const TickRadioCircle = (_0)=>{
    ...
    return /*#__PURE__*/ external_react_default().createElement(Circle, _object_spread_props(_object_spread({}, restDivAttributes), {
...
exports.TickRadioCircle = __webpack_exports__.TickRadioCircle;
