...
const Search_16_cjs_namespaceObject = require("../../../atoms/icons/Search-16.cjs");
var Search_16_cjs_default = /*#__PURE__*/ __webpack_require__.n(Search_16_cjs_namespaceObject);
...
function FieldSearch_ownKeys(object, enumerableOnly) {
...
function _object_spread_props(target, source) {
    ...
    else FieldSearch_ownKeys(Object(source)).forEach(function(key) {
...
const FieldSearch = /*#__PURE__*/ (0, external_react_namespaceObject.forwardRef)((_0, _1)=>{
    let _ref = [
        _0,
        _1
    ], [_ref1, ..._rest] = _ref, { additionalActionNode, disabled, iconUnits, name, onChange, onChangeValue, status, tabIndex, value = '' } = _ref1, restInputHtmlProps = _object_without_properties(_ref1, [
    ...
    const handleClear = ()=>{
        if (!disabled) null == onChangeValue || onChangeValue('', name);
    };
    ...
    }, /*#__PURE__*/ external_react_default().createElement(Field_styles_cjs_namespaceObject.FieldStyles.IconLeftWrap, {
        "aria-hidden": true
    }, /*#__PURE__*/ external_react_default().createElement(Search_16_cjs_default(), null)), /*#__PURE__*/ external_react_default().createElement(Field_styles_cjs_namespaceObject.FieldStyles.InputElement, _object_spread_props(_object_spread({}, restInputHtmlProps), {
    ...
    }, statusIcon), value && onChangeValue && /*#__PURE__*/ external_react_default().createElement(Field_styles_cjs_namespaceObject.FieldStyles.IconRightWrap, {
        "aria-hidden": true
    }, /*#__PURE__*/ external_react_default().createElement(index_cjs_namespaceObject.ButtonMinimal, {
        onClick: handleClear,
        iconOnly: /*#__PURE__*/ external_react_default().createElement(Cross_16_cjs_default(), null),
        tabIndex: -1
