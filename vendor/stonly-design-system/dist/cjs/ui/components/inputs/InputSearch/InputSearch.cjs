...
const external_FieldSearch_index_cjs_namespaceObject = require("../FieldSearch/index.cjs");
...
const InputSearch = /*#__PURE__*/ (0, external_react_namespaceObject.forwardRef)((_0, _1)=>{
    let _ref = [
        _0,
        _1
    ...
    return /*#__PURE__*/ external_react_default().createElement(index_cjs_namespaceObject.InputWrap, {
        ...
        status: status,
        tooltip: tooltip
    }, /*#__PURE__*/ external_react_default().createElement(external_FieldSearch_index_cjs_namespaceObject.FieldSearch, _object_spread_props(_object_spread({
