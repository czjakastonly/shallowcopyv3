...
const FieldText = /*#__PURE__*/ (0, external_react_namespaceObject.forwardRef)((_0, _1)=>{
    let _ref = [
        _0,
        _1
    ...
    }, statusIcon), iconRight && /*#__PURE__*/ external_react_default().createElement(Field_styles_cjs_namespaceObject.FieldStyles.IconRightWrap, {
        "aria-hidden": true
    }, iconRight)), !!additionalActionNode && /*#__PURE__*/ external_react_default().createElement(Field_styles_cjs_namespaceObject.FieldStyles.ButtonElementWrap, null, additionalActionNode));
});
