...
const ActionsDialog = (_0)=>{
    let { autoFocusMode, children, className, closeAction, contentWrapMode = 'standard', id, initialState, isLoading, primaryAction, primaryButtonComponent = ButtonPrimary_index_cjs_namespaceObject.ButtonPrimary, primaryIsDisabled = false, primaryIsLoading = false, primaryLabel = '____', secondaryAction, secondaryButtonComponent = ButtonMinimal_index_cjs_namespaceObject.ButtonMinimal, secondaryIsDisabled = false, secondaryLabel, showHeaderDivider, size, tertiaryRender, title, titleIcon } = _0, restDivAttributes = _object_without_properties(_0, [
        "autoFocusMode",
        "children",
        "className",
        "closeAction",
    ...
    return /*#__PURE__*/ external_react_default().createElement(DialogWrap_cjs_namespaceObject.DialogWrap, _object_spread_props(_object_spread({
        ...
        paddingTop: 3,
        paddingBottom: 2
    }, /*#__PURE__*/ external_react_default().createElement(Loader_cjs_default(), null)) : /*#__PURE__*/ external_react_default().createElement(DialogContent_cjs_namespaceObject.DialogContent, {
        isNoPadding: 'nopadding' === contentWrapMode,
        ref: contentWrapRef
    }, children)), /*#__PURE__*/ external_react_default().createElement(DialogFooterWrap_cjs_namespaceObject.DialogFooterWrap, null, shouldShowTertiary && tertiaryRender(setDialogState, dialogState), /*#__PURE__*/ external_react_default().createElement(index_cjs_namespaceObject.RowFlex, {
        gap: 2,
        marginLeft: "auto",
        flexShrink: 0
