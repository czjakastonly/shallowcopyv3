...
__webpack_require__.d(__webpack_exports__, {
    ModalWindowCloseButton: ()=>ModalWindowCloseButton
});
...
`;
const ModalWindowCloseButton = (props)=>/*#__PURE__*/ external_react_default().createElement(CloseButton, props, /*#__PURE__*/ external_react_default().createElement(CloseIcon, null));
exports.ModalWindowCloseButton = __webpack_exports__.ModalWindowCloseButton;
