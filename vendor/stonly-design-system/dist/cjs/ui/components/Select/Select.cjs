...
const SelectInteractionsContainer_cjs_namespaceObject = require("./_shared/SelectInteractionsContainer.cjs");
...
const Select = /*#__PURE__*/ external_react_default().forwardRef((_0, _1)=>{
    let _ref = [
        _0,
        _1
    ], [_ref1, ..._rest] = _ref, { as: TriggerComponent = ButtonFieldSelect_index_cjs_namespaceObject.ButtonFieldSelect, children, filterLogic = defaultFilterLogic, id, isFlipDisabled, minWidthRatio, maxHeightPx = 400, maxWidthRatio = 1, name, onChangeValue, onClose, placeholder, placeholderSearch, renderIconLeft = defaultRenderIconLeft, renderLabel = defaultRenderLabel, value, widthPx } = _ref1, restTriggerProps = _object_without_properties(_ref1, [
        "as",
        "children",
        "filterLogic",
        "id",
    ...
    const handleSelectionChange = (0, external_react_namespaceObject.useCallback)((payload)=>{
        var _ref;
    ...
    const containerId = shouldShowSearch ? (0, domId_cjs_namespaceObject.generateDialogDomId)(triggerId, isOpen) : (0, domId_cjs_namespaceObject.generateListboxDomId)(triggerId, isOpen);
    ...
    return /*#__PURE__*/ external_react_default().createElement(external_react_default().Fragment, null, /*#__PURE__*/ external_react_default().createElement(TriggerComponent, _object_spread_props(_object_spread({}, restTriggerProps, triggerProps), {
        ...
        ref: triggerRef,
        role: "combobox"
    }), triggerLabel || placeholder || ''), isOpen && /*#__PURE__*/ external_react_default().createElement(index_cjs_namespaceObject.Popover, _object_spread({
        isFocusLocked: false
    }, floatingProps), /*#__PURE__*/ external_react_default().createElement(InteractionSelect_index_cjs_namespaceObject.InteractionSelectProvider, {
        selectedValue: value
        ...
        onPostAction: close
    }, /*#__PURE__*/ external_react_default().createElement(SelectInteractionsContainer_cjs_namespaceObject.SelectInteractionsContainer, {
