...
__webpack_require__.d(__webpack_exports__, {
    ModalPanelCloseButton: ()=>ModalPanelCloseButton
});
...
`;
const ModalPanelCloseButton = (props)=>/*#__PURE__*/ external_react_default().createElement(CloseButton, props, /*#__PURE__*/ external_react_default().createElement(CloseIcon, null));
