...
import { DialogContentContainer } from "./components/DialogContentContainer.js";
...
const MiniDialog = (_0)=>{
    let { autoFocusMode, children, className, backAction, id, initialState, isLoading, primaryAction, primaryButtonComponent = ButtonPrimary, primaryIsDisabled = false, primaryIsLoading = false, primaryLabel = '____', secondaryAction, secondaryButtonComponent = ButtonMinimal, secondaryIsDisabled = false, secondaryLabel, showHeaderDivider = true, tertiaryRender, title } = _0, restDivAttributes = _object_without_properties(_0, [
        "autoFocusMode",
        "children",
        "className",
        "backAction",
    ...
    }, shouldShowHeader && /*#__PURE__*/ react.createElement(DialogHeader, {
    ...
    }, /*#__PURE__*/ react.createElement(Loader, null)) : /*#__PURE__*/ react.createElement(DialogContentContainer, {
        ref: contentWrapRef
    }, children)), shouldShowFooter && /*#__PURE__*/ react.createElement(DialogFooterWrap, null, shouldShowTertiary && tertiaryRender(setDialogState, dialogState), /*#__PURE__*/ react.createElement(RowFlex, {
        gap: 2,
        marginLeft: "auto",
        flexShrink: 0
