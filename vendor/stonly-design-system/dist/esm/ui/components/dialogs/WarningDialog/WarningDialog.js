...
const WarningDialog = (_0)=>{
    let { autoFocusMode, children, className, closeAction, id, initialState, isLoading, primaryAction, primaryButtonComponent = ButtonPrimary, primaryIsDisabled = false, primaryIsLoading = false, primaryLabel = '____', secondaryAction, secondaryButtonComponent = ButtonOutline, secondaryIsDisabled = false, secondaryLabel, severity, size = 'small', tertiaryRender, title, titleIcon } = _0, restDivAttributes = _object_without_properties(_0, [
        "autoFocusMode",
        "children",
        "className",
        "closeAction",
    ...
    return /*#__PURE__*/ react.createElement(DialogWrap, _object_spread_props(_object_spread({
        ...
        paddingTop: 4,
        paddingBottom: 1
    }, /*#__PURE__*/ react.createElement(Loader, null)) : /*#__PURE__*/ react.createElement(DialogContent, null, children)), /*#__PURE__*/ react.createElement(DialogFooterWrap, null, shouldShowTertiary && tertiaryRender(setDialogState, dialogState), /*#__PURE__*/ react.createElement(RowFlex, {
        gap: 2,
        marginLeft: "auto",
        marginRight: "auto"
