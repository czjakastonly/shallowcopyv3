...
import { withListBoxInteractionContainer } from "./withListBoxInteractionContainer.js";
...
function withListBox(Container) {
    ...
    return /*#__PURE__*/ react.forwardRef((_0, _1)=>{
        ...
        return /*#__PURE__*/ react.createElement(InteractionSelectProvider, {
            selectedValue: value
        ...
        }, /*#__PURE__*/ react.createElement(ListBoxContainer, _object_spread_props(_object_spread({}, restListBoxProps), {
            ref: forwardedRef
        }), children)))));
    });
}
